...
## 2026-08-28 | scope: deploy | trigger: 另一 session 的 handoff 說「skill 已部署、deploy 全綠」，本機 `~/.agents/skills` 沒有該 skill；bol gate 的 block 版本機 08-27 生效、第二台 Mac 到 08-28 才拿到
