...
Evidence: 2026-08-20, `.claude/handoffs/2026-08-20-122706-session-title-as-address.md`. Both classes redacted (`~/git/agent-scripts`, `<peer-host>`/`<this-host>`); the cell then passed. Peer session 37839e4b quoted the original first line verbatim, which is how the misattribution was caught.
Status: proposed
